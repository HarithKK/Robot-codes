...
void doFineTune(){
    while(1){
      ...
      if(sensorReadings[2]==0 && (sensorReadings[3]==1 )){
        lMotorReverse(100);
        rMotorForward(100);
      }
      stopMotors();
      delay(100);
      if(sensorReadings[3]==0 && (sensorReadings[2]==1 )){
        rMotorReverse(100);
        lMotorForward(100);
      }
      delay(100);
