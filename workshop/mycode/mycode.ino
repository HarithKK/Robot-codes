...
//  if (pathTurn[turnCount-1] != 'B')
//    return;

  if (pathTurn[turnCount-2] != 'B')//mada eka
    return; 
  ...
  switch (tc)
  {
  case 0:turnModeState='S';break;
  case 1:turnModeState= 'R';break;
  case 2:turnModeState = 'B';break;
  case 3:turnModeState = 'L';break;
  }
  
  pathTurn[turnCount - 3] =turnModeState;
  turnCount -= 2;
