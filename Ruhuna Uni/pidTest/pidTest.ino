...
int rightMaxSpeed=220; // max speed of the robot
int leftMaxSpeed=220; // max speed of the robot
int rightBaseSpeed=90; // this is the speed at which the motors should spin when the robot is perfectly on the line
int leftBaseSpeed=90;  // this is the speed at which the motors should spin when the robot is perfectly on the line  
...
QTRSensorsRC qtrrc((unsigned char[]) { 46, 42, 40, 38, 36,34},NUM_SENSORS, TIMEOUT, EMITTER_PIN); 
